module ForwardingUnit(EX_MEMregWrite, MEM_WBregWrite, EX_MEMrc, MEM_WBrc, ID_EXra, ID_EXrb, forwardA, forwardB);
	...
	always@(EX_MEMregWrite or MEM_WBregWrite or EX_MEMrc or MEM_WBrc or ID_EXra or ID_EXrb) begin
		if (MEM_WBregWrite == 1 && MEM_WBrc != 0 && MEM_WBrc == ID_EXra) begin
			forwardA = 2'b01;
		end else if (MEM_WBregWrite == 1 && MEM_WBrc != 0 && MEM_WBrc == ID_EXra) begin
			forwardA = 2'b10;
		end else begin
			forwardA = 2'b00;
		end
	...
	always@(EX_MEMregWrite or MEM_WBregWrite or EX_MEMrc or MEM_WBrc or ID_EXrb) begin
		if (MEM_WBregWrite == 1 && MEM_WBrc != 0 && MEM_WBrc == ID_EXrb) begin
			forwardB = 2'b01;
		end else if (MEM_WBregWrite == 1 && MEM_WBrc != 0 && MEM_WBrc == ID_EXrb) begin
			forwardB = 2'b10;
		end else begin
			forwardB = 2'b00;
		end
